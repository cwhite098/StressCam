...
class StroopTest:
    ...
    def __init__(self, sound=False):
        ...
        self.wrong_texts = ['Oops!', 'Nope!', 'Not a chance!', 'Try Harder!', 'The COLOUR not the word...',
                            'Not good enough!', 'Is that it?!', 'Do better!', 'More!']
        ...
        if self.sound:
            self.sound_thread = multiprocessing.Process(target=playsound, args=('stroop/rising.mp3',))
    ...
    def run(self, mode):
        ...
        if mode == 'easy':
            ...
            timeout = 1
        self.close_button = Button(self.root, text='close', command=self.quit_selected)
        self.close_button.pack(padx=50, pady=50)
        self.mode = mode
